...
local xxxx = 1
local lastnum = 0
function drawbar(y, num, nmax)
  
  gpu.setBackground(0xFF0000)
  gpu.fill(xxxx+num-lastnum, y, w, y, "I")
  gpu.setBackground(0x00FF00)
  xxxx = xxxx+num-lastnum
  lastnum = num
  gpu.fill(1, y, xxxx*w/nmax/3 , y, "X")
  gpu.setBackground(0x000000)
...
local scripts = {}
for _, file1 in ipairs(rom_invoke("list", "boot")) do
  lload = lload+1
end
local load = lload
...
for c, t in component.list() do load = load+1 end
